        ...
        availabilityDates: [
          {
            startDate: availabilityDates.startDate
              ? new Date(availabilityDates.startDate)
              : null,
            endDate: availabilityDates.endDate
              ? new Date(availabilityDates.endDate)
              : null,
          },
        ],
      };
    ...
    <div className="productform-container container mt-4">
      ...
      <Form onSubmit={handleSubmit}>
        {submitMessage && (
          <Alert
            variant={
              submitMessage.includes("Updated successfully")
                ? "success"
                : "danger"
            }
          >
          ...
          <Col md={6}>
            <Form.Group controlId="productName">
              ...
              <Form.Control
                ...
                required
              />
              <Form.Text className="text-muted">{t("form.nameHint")}</Form.Text>
            </Form.Group>
          </Col>
          <Col md={6}>
